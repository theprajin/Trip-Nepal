...
public class SagarmathaNPMapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition Kathmandu = CameraPosition.builder().target(new LatLng(27.9783, 86.6611)).zoom(10).bearing(0).tilt(45).build();
