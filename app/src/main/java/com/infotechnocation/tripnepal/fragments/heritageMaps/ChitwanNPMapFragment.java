...
public class ChitwanNPMapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition Kathmandu = CameraPosition.builder().target(new LatLng(27.5341, 84.4525)).zoom(10).bearing(0).tilt(45).build();
