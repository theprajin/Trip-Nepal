...
public class LumbiniMapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition Kathmandu = CameraPosition.builder().target(new LatLng(27.6792, 83.5070)).zoom(10).bearing(0).tilt(45).build();
