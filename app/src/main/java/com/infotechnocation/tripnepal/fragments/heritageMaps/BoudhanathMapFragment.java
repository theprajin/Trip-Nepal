...
public class BoudhanathMapFragment extends Fragment implements OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.addMarker(new MarkerOptions().position(new LatLng(27.7214, 85.3619)).title("Marker in Boudhanath"));
